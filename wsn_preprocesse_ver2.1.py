...
def add_sensor_data(sensor_sheets: List[Dict[str, Any]], 
    ...
    # 対象のシートにデータを追加（DataFrameがまだセットされていない場合は初期化）
